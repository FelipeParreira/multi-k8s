...
kubectl set image deployments/client-deployment server=felipeparreirafb/multi-client:$SHA
kubectl set image deployments/worker-deployment server=felipeparreirafb/multi-worker:$SHA