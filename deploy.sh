...
kubectl set image deployments/client-deployment client=felipeparreirafb/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=felipeparreirafb/multi-worker:$SHA